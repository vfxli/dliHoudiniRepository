...
class SOP_PathDeform : public SOP_Node
{
public:
	SOP_PathDeform(OP_Network *net, const char *name, OP_Operator *op);
	virtual ~SOP_PathDeform();
...
private:
	...
	int PARM_STRETCH_TOLEN() { return evalInt("stretch_tp_len", 0, 0); }
